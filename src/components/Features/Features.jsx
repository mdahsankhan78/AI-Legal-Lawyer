...
const Features = () => {
    return (
        <div className="flex flex-col gap-y-8 paddingx py-20" id='features'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {features.map((feature, i) => (
                    <div className={`${i === 3 ? 'lg:col-span-2' : 'col-span-1'} bg-cover bg-center flex flex-col justify-end px-4 py-3 text-white modern max-h-60 h-full w-full shadow-feature transition-all relative`} style={{backgroundImage:`url(/features${feature.img})`,aspectRatio:'16/9'}}>
